...
?>
			...
			<div id='<?php echo $thisMapID; ?>' style='height:<?php echo esc_attr($atts['height']); ?>;width:<?php echo esc_attr($atts['width']); ?>' data-center='<?php echo $center; ?>' data-zoom='<?php echo $zoom; ?>' data-scroll-zoom='<?php echo json_encode($scrollZoom); ?>' data-pitch='<?php echo $pitch; ?>' data-bearing='<?php echo $bearing; ?>' data-style='<?php echo $style; ?>' data-controls='<?php echo json_encode($map_object->controls); ?>' data-mapdata='<?php echo esc_html(json_encode($map_object->mapData)); ?>' data-token='<?php echo get_option('mapbox_gl_js_access_token', true); ?>' data-map-categories='<?php echo json_encode($mapCategories); ?>' data-map-origin='<?php echo json_encode($mapOrigin); ?>' data-map-destination='<?php echo json_encode($mapDestination); ?>' data-map-layers-filter='<?php echo json_encode($mapLayersFilter); ?>' class="wp-mapbox-gl-js-map"></div>
		<?php
			...
			<div>
				...
				?>
					<div id='<?php echo esc_attr($thisMapMenuID); ?>' class="wp-mapbox-gl-js-map-menu">
						...
						?>
							<input id='<?php echo esc_attr($style); ?>' type='radio' name='<?php echo esc_attr($thisMapMenuID); ?>' data-map-id="<?php echo esc_attr($thisMapID); ?>" <?php if ($index == 0) {
				...
				<?php } ?>
				<div id='<?php echo $thisMapID; ?>' style='height:<?php echo esc_attr($atts['height']); ?>;width:<?php echo esc_attr($atts['width']); ?>' data-center='<?php echo esc_attr($atts['center']); ?>' data-zoom='<?php echo esc_attr($atts['zoom']); ?>' data-scrollZoom='<?php echo esc_attr($atts['scrollZoom']); ?>' data-pitch='<?php echo esc_attr($atts['pitch']); ?>' data-bearing='<?php echo esc_attr($atts['bearing']); ?>' data-style='<?php echo esc_attr($first_style); ?>' data-token='<?php echo get_option('mapbox_gl_js_access_token', true); ?>' data-map-categories='<?php echo json_encode($mapCategories); ?>' data-map-layers-filter='<?php echo json_encode($mapLayersFilter); ?>' class="wp-mapbox-gl-js-map"></div>
			</div>
